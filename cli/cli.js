...
// Subcommands (`HydraROUTER xai video …`) run against an already-running gateway
...
Commands:
  xai video --prompt "..." --output video.mp4
                      ...
                      (see: HydraROUTER xai video --help)
`);
    process.exit(0);
      ...
      while (true) {
        ...
        if (choice === "update") {
          ...
          if (process.platform === "darwin") {
            ...
            console.log(`🔔 hydrarouter is running in tray (PID: ${process.pid})`);
            console.log(`   Server: http://${displayHost}:${port}`);
          ...
          console.log(`🔔 hydrarouter is now running in background (PID: ${bgProcess.pid})`);
          console.log(`   Server: http://${displayHost}:${port}`);
          console.log(`\n💡 You can close this terminal. Right-click tray icon to quit.\n`);
