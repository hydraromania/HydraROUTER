...
function resolveStandaloneBuild(appDir, buildDistDir) {
  ...
  // NEXT_TRACING_ROOT_MODE=workspace, e.g. standalone/HydraROUTER/server.js.
...
function buildCliPackage() {
  console.log("📦 Building hydrarouter CLI package with Next.js...\n");
  ...
  // Strip better-sqlite3 (native) — it lives in ~/.HydraROUTER/runtime to avoid
  ...
  if (fs.existsSync(betterDir)) {
    ...
    console.log("✅ Stripped better-sqlite3 (lives in ~/.hydrarouter/runtime)");
  }
  console.log("");
