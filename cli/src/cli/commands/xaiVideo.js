/**
 * `HydraROUTER xai video` — generate a Grok Imagine video through the local
 * HydraROUTER gateway and save the result as an MP4 file.
 *
...
const HELP = `
Usage: HydraROUTER xai video --prompt "..." [options]

Generate a Grok Imagine video via your local HydraROUTER gateway
...
Options:
  ...
  --api-key <key>         HydraROUTER API key (or env NINE_ROUTER_API_KEY)
...
async function run(argv) {
  ...
  try {
    ...
    const connectionId = create.headers["x-HydraROUTER-connection-id"] || null;
