...
const APP_LABEL = "com.HydraROUTER.autostart";
 ...
 *   2. `process.argv[1]` if it's our cli.js — true when HydraROUTER is currently
 ...
 * SIGTERM to the running process. When the running HydraROUTER cli.js was itself
...
<dict>
    ...
    <string>/tmp/HydraROUTER.log</string>
    <key>StandardErrorPath</key>
    <string>/tmp/HydraROUTER.error.log</string>
</dict>
</plist>`;
...
function enableWindows(cliPath) {
  ...
  // `HydraROUTER.cmd` lookup that depended on the npm prefix path.
