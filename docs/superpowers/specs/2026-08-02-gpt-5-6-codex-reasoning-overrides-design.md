...
The same matrix applies to hydrarouter's virtual `-review` variants because they
...
- Adding Codex Ultra's multi-agent orchestration behavior inside hydrarouter;
  hydrarouter only forwards the catalog-advertised reasoning override.
