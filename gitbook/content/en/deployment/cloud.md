...
Deploy hydrarouter on VPS or Docker for remote access and production use.
...
| `DATA_DIR` | `~/.hydrarouter` | Database and data storage path |
...
Create `/etc/nginx/sites-available/hydrarouter`:
