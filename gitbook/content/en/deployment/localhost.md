...
Run hydrarouter on your local machine for development and personal use.

---

## 📦 Installation

Install hydrarouter globally via npm:
...
Start hydrarouter with a single command:
...
Press `Ctrl+C` in the terminal where hydrarouter is running.

```bash
# In the terminal running hydrarouter
^C  # Press Ctrl+C
```
