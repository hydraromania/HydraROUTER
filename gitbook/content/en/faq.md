...
Common questions about hydrarouter.

---

## What is hydrarouter?

**hydrarouter is an AI model router that maximizes your subscription value and minimizes costs.**
...
**hydrarouter uses a 3-tier pricing strategy:**
...
**Yes, hydrarouter itself is 100% free and open source.**
...
**Yes! This is hydrarouter's core feature.**
...
**hydrarouter tracks quota in real-time for all providers:**
...
## Can I self-host hydrarouter?

**Yes! hydrarouter supports multiple deployment options:**
...
- `DATA_DIR` - Database storage path (default: `~/.hydrarouter`)
...
**Yes, hydrarouter prioritizes security and privacy:**

**Local storage:**
- All data stored locally in `~/.hydrarouter` (or custom `DATA_DIR`)
- No data sent to hydrarouter servers
...
**What hydrarouter stores:**
- Provider OAuth tokens (encrypted)
- API keys (encrypted)
- Usage statistics (local only)
- Combo configurations

**What hydrarouter does NOT store:**
...
**Breaking changes:**
- Check [CHANGELOG.md](https://github.com/decolua/hydrarouter/blob/main/CHANGELOG.md)
- Backup `~/.hydrarouter` before major updates
...
See [CONTRIBUTING.md](https://github.com/decolua/hydrarouter/blob/main/CONTRIBUTING.md) for details.
