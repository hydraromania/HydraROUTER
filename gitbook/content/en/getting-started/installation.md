...
Detailed installation guide for hydrarouter with troubleshooting tips.
...
Install hydrarouter globally to use from anywhere:
...
- ✅ Simple command: `hydrarouter`
- ✅ Auto-updates with `npm update -g hydrarouter`
...
3. Data directory created at `~/.hydrarouter`
...
**Issue:** hydrarouter using too much RAM
