...
Integrate hydrarouter with Claude Code CLI to route your Anthropic API requests through hydrarouter's intelligent routing system.
...
Claude Code supports the following model aliases that map to hydrarouter models:
