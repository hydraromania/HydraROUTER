...
Integrate hydrarouter with Cline VSCode extension to route your AI requests through hydrarouter's intelligent routing system.

## Prerequisites

- Visual Studio Code installed
- Cline extension installed from VSCode marketplace
- hydrarouter running locally or cloud endpoint configured
...
Set the base URL to your hydrarouter endpoint:

**For Local hydrarouter:**
```
http://localhost:20128/v1
```

**For Cloud hydrarouter:**
```
https://hydrarouter.com
```

**Steps:**
1. In the **Base URL** field, enter your hydrarouter endpoint
...
3. The key should start with `sk-hydrarouter-`

### 5. Select Model

1. In the **Model** dropdown, you can either:
   - Select from available models (if Cline auto-detects them)
   - Manually enter the model name from your hydrarouter configuration
...
4. Cline will use hydrarouter to process your request

### Code Generation

1. Ask Cline to generate code: "Create a React component for a login form"
2. Cline will generate code using hydrarouter
...
3. Get AI-powered explanations through hydrarouter

### File Operations

1. Ask Cline to create, modify, or delete files
2. Cline will use hydrarouter to understand context and make changes
...
1. Verify hydrarouter is running: `curl http://localhost:20128/health`
...
2. Verify your hydrarouter instance is running and healthy
3. Try reloading VSCode window (Cmd/Ctrl + Shift + P → "Reload Window")
4. Check hydrarouter logs for any errors

## Advanced Configuration

### Using Cloud Endpoint

To use hydrarouter cloud endpoint instead of localhost:

1. In Cline settings, set Base URL to: `https://hydrarouter.com`
2. Make sure you have configured your API key in the hydrarouter cloud dashboard
...
## Integration with hydrarouter Features

### Model Routing

hydrarouter automatically routes your requests to the best available provider based on:
- Model availability
...
If a provider fails, hydrarouter automatically falls back to alternative providers configured in your dashboard.

### Usage Tracking

Monitor your Cline usage through hydrarouter dashboard:
- Total requests
- Token usage
- Cost per model
