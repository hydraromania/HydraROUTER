...
Integrate hydrarouter with OpenAI Codex CLI to route your OpenAI API requests through hydrarouter's intelligent routing system.
...
hydrarouter provides the following Codex models:
...
1. Verify your API key is correct in hydrarouter dashboard
...
1. Verify the model name matches your hydrarouter configuration
2. Check that the OpenAI provider connection is active in hydrarouter dashboard
...
Make sure you have configured your API key in the hydrarouter cloud dashboard.
