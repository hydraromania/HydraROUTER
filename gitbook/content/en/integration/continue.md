...
Integrate hydrarouter with Continue extension to bring AI assistance directly into Visual Studio Code.

## Prerequisites

- Visual Studio Code installed
- Continue extension installed from VSCode marketplace
- hydrarouter API key from [dashboard](https://hydrarouter.com/dashboard)
- hydrarouter running (local or cloud)
...
### 2. Add hydrarouter Model Configuration
...
3. Choose your preferred hydrarouter model
...
- Check network latency to hydrarouter
