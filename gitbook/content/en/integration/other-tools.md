...
hydrarouter is compatible with any tool that supports the OpenAI API format. This guide covers generic integration patterns for various tools and custom applications.

## Overview

hydrarouter provides an OpenAI-compatible API endpoint that works with:
...
Any OpenAI-compatible tool can connect to hydrarouter using these settings:

**Local hydrarouter:**
```
Base URL: http://localhost:20128/v1
API Key: your-api-key-from-dashboard
Model: any hydrarouter model (cc/*, cx/*, glm/*, etc.)
```
...
**Problem:** Cannot connect to hydrarouter
```bash
...
- Check network connection to hydrarouter
