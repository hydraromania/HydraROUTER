...
Common issues and solutions when using hydrarouter.
...
1. **Auto-refresh (default):**
   hydrarouter automatically refreshes tokens. Wait 30 seconds and retry.
...
1. **Check if hydrarouter is running:**
   ```bash
   # Check process
