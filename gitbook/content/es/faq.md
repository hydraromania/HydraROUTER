...
Preguntas comunes sobre hydrarouter.

---

## ¿Qué es hydrarouter?

**hydrarouter es un router de modelos de IA que maximiza el valor de tu suscripción y minimiza los costos.**
...
**hydrarouter usa una estrategia de precios de 3 niveles:**
...
## ¿hydrarouter es gratis?

**Sí, hydrarouter en sí es 100% gratis y open source.**
...
**¡Sí! Esta es la característica principal de hydrarouter.**
...
**hydrarouter rastrea la cuota en tiempo real para todos los proveedores:**
...
## ¿hydrarouter funciona con Cursor?

**Sí, pero Cursor requiere un endpoint en la nube.**

**Problema:** Cursor IDE no soporta endpoints en localhost.

**Solución:** Usa el despliegue en la nube de hydrarouter:

```
Cursor Settings → Models → Advanced:
  OpenAI API Base URL: https://hydrarouter.com/v1
...
## ¿Puedo auto-hospedar hydrarouter?

**¡Sí! hydrarouter soporta múltiples opciones de despliegue:**
...
- `DATA_DIR` - Ruta de almacenamiento de la base de datos (por defecto: `~/.hydrarouter`)
...
**Sí, hydrarouter prioriza la seguridad y privacidad:**

**Almacenamiento local:**
- Todos los datos se almacenan localmente en `~/.hydrarouter` (o `DATA_DIR` personalizado)
- No se envían datos a los servidores de hydrarouter
...
### Docker
```bash
docker pull hydrarouter:latest
...
**Cambios disruptivos:**
- Revisa [CHANGELOG.md](https://github.com/decolua/hydrarouter/blob/main/CHANGELOG.md)
- Respalda `~/.hydrarouter` antes de actualizaciones mayores
...
1. **Reportar bugs:**
   - [GitHub Issues](https://github.com/decolua/hydrarouter/issues)
   - Incluye logs de error, pasos para reproducir

2. **Solicitar características:**
   - [GitHub Discussions](https://github.com/decolua/hydrarouter/discussions)
   - Describe el caso de uso y los beneficios

3. **Enviar código:**
   ```bash
   # Fork del repo
   git clone https://github.com/YOUR_USERNAME/hydrarouter.git
   cd hydrarouter
...
Consulta [CONTRIBUTING.md](https://github.com/decolua/hydrarouter/blob/main/CONTRIBUTING.md) para detalles.

---

## ¿Necesitas más ayuda?

- **Documentación:** [hydrarouter.com/docs](https://hydrarouter.com/docs)
