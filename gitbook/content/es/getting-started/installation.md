...
Guía detallada de instalación de hydrarouter con consejos de solución de problemas.
...
Instala hydrarouter globalmente para usar desde cualquier lugar:
...
- ✅ Comando simple: `hydrarouter`
- ✅ Auto-actualizaciones con `npm update -g hydrarouter`
...
```bash
mkdir my-hydrarouter
cd my-hydrarouter
npm install hydrarouter
```
...
3. Se crea el directorio de datos en `~/.hydrarouter`
...
**Ubicación por defecto:** `~/.hydrarouter`
...
**Error:**
```
Error: EACCES: permission denied, mkdir '/usr/local/lib/node_modules/hydrarouter'
```
...
**Problema:** hydrarouter usa demasiada RAM
...
```bash
npm install -g pm2
pm2 start hydrarouter --name hydrarouter
pm2 save
```
...
```bash
docker pull hydrarouter/hydrarouter:latest

docker run -d \
  -p 20128:20128 \
  -e JWT_SECRET="your-secure-secret" \
  -e INITIAL_PASSWORD="your-password" \
  -v hydrarouter-data:/root/.hydrarouter \
  --name hydrarouter \
  hydrarouter/hydrarouter:latest
```
...
nano ~/.bashrc  # o ~/.zshrc
# Eliminar exports relacionados con hydrarouter
```
