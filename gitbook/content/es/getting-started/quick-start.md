...
Pon en marcha hydrarouter en 5 minutos y comienza a enrutar solicitudes de IA de forma inteligente.
...
Apunta tu herramienta de codificación a hydrarouter:
...
Settings → Models → Advanced:
  ...
  OpenAI API Key: [desde el dashboard de hydrarouter]
