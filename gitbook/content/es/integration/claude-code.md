...
Integra hydrarouter con Claude Code CLI para enrutar tus solicitudes de la API de Anthropic a través del sistema de enrutamiento inteligente de hydrarouter.
...
Claude Code soporta los siguientes aliases de modelos que mapean a modelos de hydrarouter:
...
```bash
export ANTHROPIC_BASE_URL="https://hydrarouter.com"
```
