...
Integra hydrarouter con la extensión Cline de VSCode para enrutar tus solicitudes de IA a través del sistema de enrutamiento inteligente de hydrarouter.

## Requisitos previos

- Visual Studio Code instalado
- Extensión Cline instalada desde el marketplace de VSCode
- hydrarouter ejecutándose localmente o endpoint en la nube configurado
...
Establece la URL base a tu endpoint de hydrarouter:

**Para hydrarouter local:**
```
http://localhost:20128/v1
```

**Para hydrarouter en la nube:**
```
https://hydrarouter.com
```

**Pasos:**
1. En el campo **Base URL**, ingresa tu endpoint de hydrarouter
...
3. La key debe comenzar con `sk-hydrarouter-`

### 5. Seleccionar modelo

1. En el dropdown **Model**, puedes:
   - Seleccionar de los modelos disponibles (si Cline los auto-detecta)
   - Ingresar manualmente el nombre del modelo desde tu configuración de hydrarouter
...
4. Cline usará hydrarouter para procesar tu solicitud

### Generación de código

1. Pide a Cline que genere código: "Create a React component for a login form"
2. Cline generará código usando hydrarouter
...
3. Obtén explicaciones potenciadas por IA a través de hydrarouter

### Operaciones con archivos

1. Pide a Cline que cree, modifique o elimine archivos
2. Cline usará hydrarouter para entender el contexto y hacer cambios
...
1. Verifica que hydrarouter esté corriendo: `curl http://localhost:20128/health`
...
2. Verifica que tu instancia de hydrarouter esté ejecutándose y saludable
3. Intenta recargar la ventana de VSCode (Cmd/Ctrl + Shift + P → "Reload Window")
4. Revisa los logs de hydrarouter para cualquier error

## Configuración avanzada

### Usar endpoint en la nube

Para usar el endpoint en la nube de hydrarouter en lugar de localhost:

1. En la configuración de Cline, establece Base URL a: `https://hydrarouter.com`
2. Asegúrate de haber configurado tu API key en el dashboard en la nube de hydrarouter
...
## Integración con características de hydrarouter

### Enrutamiento de modelos

hydrarouter enruta automáticamente tus solicitudes al mejor proveedor disponible según:
...
Si un proveedor falla, hydrarouter automáticamente cambia a proveedores alternativos configurados en tu dashboard.

### Seguimiento de uso

Monitorea tu uso de Cline a través del dashboard de hydrarouter:
