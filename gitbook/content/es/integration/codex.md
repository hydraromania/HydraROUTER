...
Integra hydrarouter con OpenAI Codex CLI para enrutar tus solicitudes de la API de OpenAI a través del sistema de enrutamiento inteligente de hydrarouter.
...
hydrarouter proporciona los siguientes modelos de Codex:
...
```json
{
  ...
  "apiKey": "your-hydrarouter-api-key",
...
1. Verifica que tu API key sea correcta en el dashboard de hydrarouter
...
1. Verifica que el nombre del modelo coincida con tu configuración de hydrarouter
2. Verifica que la conexión del proveedor de OpenAI esté activa en el dashboard de hydrarouter
...
```bash
export OPENAI_BASE_URL="https://hydrarouter.com"
```

Asegúrate de haber configurado tu API key en el dashboard en la nube de hydrarouter.
