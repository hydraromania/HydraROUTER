...
Integra hydrarouter con la extensión Continue para llevar la asistencia de IA directamente a Visual Studio Code.

## Requisitos previos

- Visual Studio Code instalado
- Extensión Continue instalada desde el marketplace de VSCode
- API key de hydrarouter desde el [dashboard](https://hydrarouter.com/dashboard)
- hydrarouter ejecutándose (local o en la nube)
...
### 2. Agregar configuración de modelo de hydrarouter
...
```json
{
  "models": [
    {
      "title": "hydrarouter - Claude Opus (Best)",
      "provider": "openai",
      "model": "cc/claude-opus-4-5-20251101",
      "apiKey": "your-api-key-from-dashboard",
      "apiBase": "http://localhost:20128/v1"
    ...
    {
      "title": "hydrarouter - Claude Sonnet (Balanced)",
      "provider": "openai",
    ...
    {
      "title": "hydrarouter - DeepSeek Chat (Code)",
      "provider": "openai",
    ...
    {
      "title": "hydrarouter - Claude Haiku (Fast)",
      "provider": "openai",
...
```json
"apiBase": "https://hydrarouter.com/v1"
```
...
3. Elige tu modelo preferido de hydrarouter
...
```json
{
  "models": [
    {
      "title": "hydrarouter - Creative Writer",
      "provider": "openai",
      "model": "cc/claude-opus-4-5-20251101",
      "apiKey": "your-api-key",
      "apiBase": "http://localhost:20128/v1",
...
- Verifica que hydrarouter esté corriendo: `curl http://localhost:20128/health`
...
- Selecciona el modelo correcto de hydrarouter
...
- Verifica la latencia de red hacia hydrarouter
