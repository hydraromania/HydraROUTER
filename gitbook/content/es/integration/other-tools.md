...
hydrarouter es compatible con cualquier herramienta que soporte el formato de API de OpenAI. Esta guía cubre patrones de integración genéricos para varias herramientas y aplicaciones personalizadas.

## Resumen

hydrarouter proporciona un endpoint de API compatible con OpenAI que funciona con:
...
Cualquier herramienta compatible con OpenAI puede conectarse a hydrarouter usando estas configuraciones:

**hydrarouter local:**
```
Base URL: http://localhost:20128/v1
API Key: your-api-key-from-dashboard
Model: cualquier modelo de hydrarouter (cc/*, cx/*, glm/*, etc.)
```

**hydrarouter en la nube:**
```
Base URL: https://hydrarouter.com/v1
API Key: your-api-key-from-dashboard
Model: cualquier modelo de hydrarouter (cc/*, cx/*, glm/*, etc.)
```
...
**Problema:** No se puede conectar a hydrarouter
```bash
# Verifica si hydrarouter está corriendo
...
**Solución:**
- Verifica que hydrarouter esté corriendo
...
- Verifica la conexión de red a hydrarouter
