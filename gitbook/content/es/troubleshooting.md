...
Problemas comunes y soluciones al usar hydrarouter.
...
1. **Refresh automático (por defecto):**
   hydrarouter refresca automáticamente los tokens. Espera 30 segundos y reintenta.
...
**Causas:**
- hydrarouter no está ejecutándose
- Puerto 20128 bloqueado
- Firewall bloqueando la conexión

**Soluciones:**

1. **Inicia hydrarouter:**
   ```bash
   hydrarouter
   ```
...
4. **Usa el endpoint en la nube:**
   ...
   ```
   Endpoint: https://hydrarouter.com/v1
   ```
...
1. **Verifica si hydrarouter está ejecutándose:**
   ```bash
   # Verifica el proceso
   ps aux | grep hydrarouter
...
- **GitHub Issues:** [github.com/decolua/hydrarouter/issues](https://github.com/decolua/hydrarouter/issues)
