...
開発と個人利用のため、ローカルマシンでhydrarouterを実行。

---

## 📦 インストール

npm経由でhydrarouterをグローバルインストール:
...
hydrarouterが実行されているターミナルで `Ctrl+C` を押します。

```bash
# hydrarouterを実行しているターミナル
^C  # Ctrl+Cを押す
```
