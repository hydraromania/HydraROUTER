...
トラブルシューティングのヒント付きのhydrarouter詳細インストールガイド。
...
どこからでも使用できるようにhydrarouterをグローバルインストール:
...
**利点:**
- ✅ どのディレクトリからでも実行
- ✅ シンプルなコマンド: `hydrarouter`
- ✅ `npm update -g hydrarouter` で自動更新
...
3. `~/.hydrarouter` にデータディレクトリが作成される
4. APIキーが自動生成される
