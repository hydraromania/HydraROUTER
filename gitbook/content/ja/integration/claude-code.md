...
hydrarouterをClaude Code CLIと統合し、AnthropicのAPIリクエストをhydrarouterのインテリジェントルーティングシステム経由でルーティングします。
...
Claude Codeはhydrarouterモデルにマッピングされる以下のモデルエイリアスをサポート:
...
1. モデル名がhydrarouterの設定と一致しているか確認
