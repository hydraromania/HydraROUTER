...
hydrarouterをContinue拡張機能と統合し、Visual Studio Codeに直接AIアシスタンスを導入します。

## 前提条件

- Visual Studio Codeがインストール済み
- VSCodeマーケットプレイスからContinue拡張機能がインストール済み
- [ダッシュボード](https://hydrarouter.com/dashboard)からのhydrarouter APIキー
- hydrarouterが動作中 (ローカルまたはクラウド)
