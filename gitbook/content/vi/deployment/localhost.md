...
Chạy hydrarouter trên máy cá nhân để phát triển và dùng cá nhân.

---

## 📦 Cài đặt

Cài đặt hydrarouter toàn cục qua npm:
...
Khởi động hydrarouter với một lệnh duy nhất:
...
Nhấn `Ctrl+C` trong terminal đang chạy hydrarouter.
