...
Những câu hỏi phổ biến về hydrarouter.

---

## hydrarouter là gì?

**hydrarouter là bộ định tuyến mô hình AI giúp tối đa hóa giá trị subscription và giảm chi phí.**
...
**hydrarouter dùng chiến lược pricing 3 tầng:**
...
## hydrarouter có miễn phí không?

**Có, hydrarouter hoàn toàn miễn phí và mã nguồn mở 100%.**
...
**Có! Đây là tính năng cốt lõi của hydrarouter.**
...
**hydrarouter theo dõi quota thời gian thực cho tất cả provider:**
...
## Tôi có thể self-host hydrarouter không?

**Có! hydrarouter hỗ trợ nhiều tùy chọn deployment:**
...
- `DATA_DIR` - Đường dẫn lưu database (mặc định: `~/.hydrarouter`)
...
**Có, hydrarouter ưu tiên bảo mật và quyền riêng tư:**

**Local storage:**
- Mọi dữ liệu lưu cục bộ tại `~/.hydrarouter` (hoặc `DATA_DIR` tùy chỉnh)
- Không gửi data đến server hydrarouter
...
## Làm thế nào để cập nhật hydrarouter?
...
**Breaking changes:**
- Xem [CHANGELOG.md](https://github.com/decolua/hydrarouter/blob/main/CHANGELOG.md)
- Backup `~/.hydrarouter` trước khi update lớn
...
Xem [CONTRIBUTING.md](https://github.com/decolua/hydrarouter/blob/main/CONTRIBUTING.md) để biết chi tiết.

---

## Cần trợ giúp thêm?

- **Documentation:** [hydrarouter.com/docs](https://hydrarouter.com/docs)
