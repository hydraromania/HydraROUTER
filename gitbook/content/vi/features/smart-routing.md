...
hydrarouter tự động định tuyến request qua provider tốt nhất hiện có bằng hệ thống fallback 3 tầng. Không bao giờ ngừng code vì giới hạn quota hay rate limiting.

---

## Cách hoạt động

hydrarouter dùng định tuyến thông minh để tối đa hóa subscription hiện có, giảm chi phí và đảm bảo khả dụng 24/7:
...
hydrarouter giám sát quota thời gian thực và chuyển provider tự động:
...
hydrarouter chọn model tốt nhất dựa trên:
...
Khi đạt ngân sách, hydrarouter tự động chuyển sang free tier.
