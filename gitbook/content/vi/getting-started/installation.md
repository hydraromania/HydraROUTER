...
Hướng dẫn cài đặt chi tiết cho hydrarouter với mẹo troubleshooting.
...
Cài hydrarouter toàn cục để dùng ở bất kỳ đâu:

```bash
npm install -g hydrarouter
```

**Khởi động hydrarouter:**
...
**Lợi ích:**
- ✅ Chạy từ mọi thư mục
- ✅ Lệnh đơn giản: `hydrarouter`
- ✅ Auto-update với `npm update -g hydrarouter`
...
3. Data directory được tạo tại `~/.hydrarouter`
...
**Vấn đề:** hydrarouter dùng quá nhiều RAM
...
# Delete hydrarouter-related exports
```
