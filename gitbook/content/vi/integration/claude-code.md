...
Tích hợp hydrarouter với Claude Code CLI để định tuyến request API Anthropic qua hệ thống routing thông minh của hydrarouter.
...
Claude Code hỗ trợ các alias model sau ánh xạ sang model hydrarouter:
