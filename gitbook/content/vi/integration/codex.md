...
Tích hợp hydrarouter với OpenAI Codex CLI để định tuyến request API OpenAI qua hệ thống routing thông minh của hydrarouter.
...
hydrarouter cung cấp các model Codex sau:
...
1. Xác minh API key đúng trong hydrarouter dashboard
...
1. Xác minh tên model khớp với cấu hình hydrarouter
2. Kiểm tra kết nối provider OpenAI đang hoạt động trong hydrarouter dashboard
...
Đảm bảo bạn đã cấu hình API key trong hydrarouter cloud dashboard.
