...
Tích hợp hydrarouter với extension Continue để mang trợ lý AI trực tiếp vào Visual Studio Code.

## Yêu cầu

- Visual Studio Code đã cài đặt
- Extension Continue đã cài đặt từ VSCode marketplace
- hydrarouter API key từ [dashboard](https://hydrarouter.com/dashboard)
- hydrarouter đang chạy (cục bộ hoặc cloud)
...
### 2. Thêm Cấu hình Model hydrarouter
...
3. Chọn model hydrarouter ưa thích
...
- Kiểm tra hydrarouter đang chạy: `curl http://localhost:20128/health`
...
- Kiểm tra độ trễ network đến hydrarouter
