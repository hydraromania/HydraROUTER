...
hydrarouter tương thích với mọi công cụ hỗ trợ format API OpenAI. Hướng dẫn này bao gồm pattern tích hợp tổng quát cho nhiều công cụ và ứng dụng tùy chỉnh.

## Tổng quan

hydrarouter cung cấp API endpoint tương thích OpenAI hoạt động với:
...
Mọi công cụ tương thích OpenAI có thể kết nối đến hydrarouter bằng các cài đặt sau:
...
**Vấn đề:** Không kết nối được đến hydrarouter
```bash
...
**Giải pháp:**
- Xác minh hydrarouter đang chạy
...
- Kiểm tra kết nối network đến hydrarouter
