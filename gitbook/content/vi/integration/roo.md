...
Tích hợp hydrarouter với Roo AI Assistant để truy cập nhiều model AI qua một giao diện thống nhất.
...
Chọn từ các model hydrarouter có sẵn:
...
### Connection Failed
- Xác minh hydrarouter đang chạy: `curl http://localhost:20128/health`
