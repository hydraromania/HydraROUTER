...
Các vấn đề và giải pháp phổ biến khi dùng hydrarouter.
...
1. **Auto-refresh (mặc định):**
   hydrarouter tự refresh tokens. Đợi 30 giây rồi thử lại.
...
**Nguyên nhân:**
- hydrarouter không chạy
- Port 20128 bị chặn
- Firewall chặn kết nối

**Giải pháp:**

1. **Khởi động hydrarouter:**
   ```bash
   hydrarouter
   ```
...
- hydrarouter bị crash
- Vấn đề cache browser

**Giải pháp:**

1. **Kiểm tra hydrarouter có chạy không:**
   ```bash
   # Check process
