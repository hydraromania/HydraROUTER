...
关于 hydrarouter 的常见问题。

---

## 什么是 hydrarouter?

**hydrarouter 是一款 AI 模型路由工具,能够最大化你的订阅价值并最小化成本。**
...
**环境变量:**
- `JWT_SECRET` - **生产环境必须修改!**
- `DATA_DIR` - 数据库存储路径(默认:`~/.hydrarouter`)
...
**是的,hydrarouter 优先考虑安全和隐私:**

**本地存储:**
- 所有数据存储在本地 `~/.hydrarouter`(或自定义 `DATA_DIR`)
- 不会发送数据到 hydrarouter 服务器
...
**破坏性变更:**
- 查看 [CHANGELOG.md](https://github.com/decolua/hydrarouter/blob/main/CHANGELOG.md)
- 大版本更新前备份 `~/.hydrarouter`
- 阅读大版本的迁移指南
...
详情见 [CONTRIBUTING.md](https://github.com/decolua/hydrarouter/blob/main/CONTRIBUTING.md)。

---

## 需要更多帮助?

- **文档:** [hydrarouter.com/docs](https://hydrarouter.com/docs)
