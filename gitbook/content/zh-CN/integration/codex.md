...
将 hydrarouter 与 OpenAI Codex CLI 集成,通过 hydrarouter 的智能路由系统转发你的 OpenAI API 请求。
...
1. 在 hydrarouter 仪表盘中确认 API key 正确
...
1. 确认模型名与 hydrarouter 配置一致
2. 检查 hydrarouter 仪表盘中 OpenAI 提供商连接是否激活
3. 确认连接的提供商中包含该模型
...
确保已在 hydrarouter 云端仪表盘中配置 API key。
