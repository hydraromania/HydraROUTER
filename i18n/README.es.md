<div align="center">
  <img src="../images/hydrarouter.png?1" alt="Panel de control de hydrarouter" width="800"/>
  
  # hydrarouter - Enrutador de IA GRATUITO y ahorrador de tokens
  ...
  **Conecta todas tus herramientas de código con IA (Claude Code, Cursor, Antigravity, Copilot, Codex, Gemini, OpenCode, Cline, OpenClaw...) a más de 40 proveedores de IA y más de 100 modelos.**
  ...
  [![License](https://img.shields.io/npm/l/hydrarouter.svg)](https://github.com/decolua/hydrarouter/blob/main/LICENSE)
...
[🚀 Inicio rápido](#-inicio-rápido) • [💡 Características](#-características-principales) • [📖 Configuración](#-guía-de-instalación) • [🌐 Sitio web](https://hydrarouter.com)
...
El paquete de este repositorio es privado (`hydrarouter-app`), por lo que ejecutar desde el código fuente/Docker es la ruta de desarrollo local prevista.
...
<table>
  ...
  <b>🇻🇳 Tiếng Việt</b><br/>
  <sub>Tiết kiệm chi phí LLM cho OpenClaw với hydrarouter<br/>by <a href="https://www.youtube.com/c/M%C3%ACAIblog">Mì AI</a></sub>
</td>
<td align="center" width="320">
      ...
      <b>🇵🇰 اردو / हिन्दी</b><br/>
      <sub>hydrarouter + Claude Code FREE Unlimited Setup<br/>by <a href="https://www.youtube.com/@BuildAIWithHamid">Build AI With Hamid</a></sub>
    </td>
    <td align="center" width="320">
      ...
      <b>🇺🇸 English</b><br/>
      <sub>hydrarouter + Claude Code FREE Setup<br/>by <a href="https://www.youtube.com/@BuildAIWithHamid">Build AI With Hamid</a></sub>
    </td>
  ...
  <td align="center" width="320">
    ...
    <td align="center" width="320">
      ...
      <b>🇺🇸 English</b><br/>
      <sub>Claude CLI Free Setup with hydrarouter 🚀<br/>by <a href="https://www.youtube.com/@CodeVerseSoban">CodeVerse Soban</a></sub>
    </td>
  ...
  <td align="center" width="320">
      ...
      <b>🇻🇳 Tiếng Việt</b><br/>
      <sub>Cài Đặt OpenClaw Free Từ A-Z + hydrarouter<br/>by <a href="https://www.youtube.com/@maigia">Mai Gia</a></sub>
    </td>
    <td align="center" width="320">
    ...
    <td align="center" width="320">
      ...
      <b>🇮🇩 Indonesia</b><br/>
      <sub>Koding 24 Jam Anti Rate Limit! Hemat Token AI 65% | Tutorial Quick Setup hydrarouter 🚀<br/>by <a href="https://www.youtube.com/@krisswuh">Krisswuh</a></sub>
    </td>
  ...
  <td align="center" width="320">
      ...
      <b>🇮🇩 Indonesia</b><br/>
      <sub>Cara Deploy hydrarouter di Hugging Face GRATIS Non-Stop! | Alternatif VPS RAM 16GB<br/>by <a href="https://www.youtube.com/@krisswuh">Krisswuh</a></sub>
    </td>
  </tr>
...
> 🎬 **¿Has hecho un video sobre hydrarouter?** Envía una [Pull Request](https://github.com/decolua/hydrarouter/pulls) añadiendo tu video a esta sección — ¡lo fusionaremos!

---

## 🛠️ Herramientas CLI compatibles

hydrarouter funciona a la perfección con todas las principales herramientas de código con IA:
...
Headroom es opcional y se ejecuta por separado. hydrarouter llama al endpoint local `/v1/compress` de Headroom y luego mantiene el enrutamiento, la reserva, la autenticación y el seguimiento de uso normales:

```
Client → hydrarouter → Headroom /v1/compress → hydrarouter → provider
```
...
Si Headroom está caído o devuelve un error, hydrarouter falla de forma segura y envía la solicitud original.
...
- Tu herramienta CLI envía el formato OpenAI → hydrarouter lo traduce → El proveedor recibe el formato nativo
...
> hydrarouter por sí mismo **nunca te cobra** nada. Solo pagas a los proveedores directamente (si usas servicios de pago).
>
...
> enrutar a través de hydrarouter!
...
### 📊 Cómo entender los costes y la facturación de hydrarouter

**Realidad de la facturación de hydrarouter:**

✅ **El software de hydrarouter = GRATUITO para siempre** (código abierto, nunca cobra)  
...
❌ **hydrarouter nunca envía facturas** ni carga tu tarjeta
...
- **Proveedores económicos** (GLM, MiniMax): Págales directamente, hydrarouter solo enruta
- **Proveedores GRATUITOS** (iFlow, Kiro, Qwen): Realmente gratuitos para siempre, sin cargos ocultos
- **hydrarouter**: Nunca cobra nada, jamás
...
El panel realiza el seguimiento de tu uso de tokens y muestra **costes estimados** como si estuvieras usando APIs de pago directamente. Esto **no es facturación real** — es una referencia para mostrar cuánto estás ahorrando al usar modelos gratuitos o suscripciones existentes a través de hydrarouter.
...
<details>
<summary><b>💳 ¿hydrarouter me cobrará algo?</b></summary>

**No.** hydrarouter es un software gratuito y de código abierto que se ejecuta en tu propio ordenador. Nunca te cobra nada.

**Solo pagas:**

- ✅ **Proveedores de suscripción** (Claude Code $20/mes, Codex $20-200/mes) → Págales directamente en sus sitios web
- ✅ **Proveedores económicos** (GLM, MiniMax) → Págales directamente, hydrarouter solo enruta tus solicitudes
- ❌ **El propio hydrarouter** → **Nunca cobra nada, jamás**

hydrarouter es un proxy/enrutador local. No tiene tu tarjeta de crédito, no puede enviar facturas y no tiene sistema de facturación. Es software totalmente gratuito.
...
hydrarouter solo enruta tus solicitudes hacia ellos — no hay "trampa" ni facturación futura. Son servicios realmente gratuitos y hydrarouter los hace fáciles de usar con soporte de reserva.
...
3. **Usa los proveedores de suscripción al final:**
   ...
   - hydrarouter te ayuda a maximizar su valor mediante el seguimiento de cuota
...
La reserva inteligente de hydrarouter evita cargos sorpresa:
...
**Tú tienes el control:** Establece límites de gasto por proveedor en el panel y hydrarouter los respeta.
...
**Consejo profesional:** Usa Opus para tareas complejas y Sonnet para velocidad. ¡hydrarouter realiza el seguimiento de la cuota por modelo!
...
Settings → Models → Advanced:
  ...
  OpenAI API Key: [desde el panel de hydrarouter]
...
```json
{
  ...
  "anthropic_api_key": "tu-clave-api-de-hydrarouter"
}
```
...
export OPENAI_API_KEY="tu-clave-api-de-hydrarouter"
...
> **Nota:** OpenClaw solo funciona con hydrarouter local. Usa `127.0.0.1` en lugar de `localhost` para evitar problemas de resolución IPv6.
...
- Docker Hub: [`decolua/hydrarouter`](https://hub.docker.com/r/decolua/hydrarouter)
...
docker pull decolua/hydrarouter:latest   # actualiza a la última versión
```

**Persistencia de datos:** `$HOME/.hydrarouter/db/data.sqlite` en el host ↔ `/app/data/db/data.sqlite` en el contenedor.

### Variables de entorno

| Variable                                             | Por defecto                                | Descripción                                                                          |
| ---------------------------------------------------- | ------------------------------------------ | ------------------------------------------------------------------------------------ |
| `JWT_SECRET`                                         | Generado automáticamente (`~/.hydrarouter/jwt-secret`) | Secreto de firma JWT para la cookie de autenticación del panel (sobreescríbelo para compartir entre instancias) |
| `INITIAL_PASSWORD`                                   | `123456`                                   | Contraseña del primer inicio de sesión cuando no existe un hash guardado             |
| `DATA_DIR`                                           | `~/.hydrarouter`                               | Ubicación principal de datos de la app (SQLite en `$DATA_DIR/db/data.sqlite`)        |
...
| `CLOUD_URL`                                          | `https://hydrarouter.com`                      | URL base del endpoint de sincronización en la nube del lado del servidor             |
...
| `NEXT_PUBLIC_CLOUD_URL`                              | `https://hydrarouter.com`                      | URL de nube pública/compatible (prefiere `CLOUD_URL` para el runtime del servidor)   |
...
- Tanto `${DATA_DIR}` como `~/.hydrarouter` resuelven a la misma ubicación en un contenedor de Docker — el enlace simbólico `/root/.hydrarouter -> /app/data` se crea en tiempo de compilación.
...
- hydrarouter lo renueva automáticamente
...
- **Sitio web**: [hydrarouter.com](https://hydrarouter.com)
- **GitHub**: [github.com/decolua/hydrarouter](https://github.com/decolua/hydrarouter)
- **Problemas**: [github.com/decolua/hydrarouter/issues](https://github.com/decolua/hydrarouter/issues)

---

## 👥 Colaboradores

¡Gracias a todos los colaboradores que ayudaron a mejorar hydrarouter!

[![Contributors](https://contrib.rocks/image?repo=decolua/hydrarouter&max=150&columns=15&anon=1&v=20260309)](https://github.com/decolua/hydrarouter/graphs/contributors)

---

## 📊 Gráfico de estrellas

[![Star Chart](https://starchart.cc/decolua/hydrarouter.svg?variant=adaptive)](https://starchart.cc/decolua/hydrarouter)

## 🔀 Forks

**[OmniRoute](https://github.com/diegosouzapw/OmniRoute)** — Un fork de hydrarouter en TypeScript con todas las funciones. Añade más de 36 proveedores, reserva automática de 4 niveles, APIs multimodales (imágenes, embeddings, audio, TTS), interruptor de circuitos, caché semántica, evaluaciones de LLM y un panel pulido. Más de 368 pruebas unitarias. Disponible a través de npm y Docker.
...
- **[RTK](https://github.com/rtk-ai/rtk)** ![Stars](https://img.shields.io/github/stars/rtk-ai/rtk?style=flat&color=yellow) — ahorrador de tokens en Rust. hydrarouter porta su pipeline de compresión a JS → **−20-40% de tokens de entrada** en cada solicitud.
- **[Caveman](https://github.com/JuliusBrussee/caveman)** ![Stars](https://img.shields.io/github/stars/JuliusBrussee/caveman?style=flat&color=yellow) por **[@JuliusBrussee](https://github.com/JuliusBrussee)** — viral _"why use many token when few token do trick"_. hydrarouter adapta su prompt → **−65% de tokens de salida**.
- **[Ponytail](https://github.com/DietrichGebert/ponytail)** ![Stars](https://img.shields.io/github/stars/DietrichGebert/ponytail?style=flat&color=yellow) por **[@DietrichGebert](https://github.com/DietrichGebert)** — habilidad del _"dev sénior perezoso"_. hydrarouter inyecta su jerarquía primero-YAGNI → **menos tokens, menos código, diffs más cortos**.

Un enorme agradecimiento a estos autores — sin su trabajo, las funciones de ahorro de tokens de hydrarouter no existirían. ¡Dales una ⭐ en GitHub!
