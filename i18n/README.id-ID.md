<div align="center">
  ...
  **Hubungkan semua tool AI coding (Claude Code, Cursor, Antigravity, Copilot, Codex, Gemini, OpenCode, Cline, OpenClaw...) ke 40+ provider AI dan 100+ model.**
  ...
  [🚀 Mulai Cepat](#-mulai-cepat) • [💡 Fitur](#-fitur-utama) • [📖 Setup](#-panduan-setup) • [🌐 Website](https://hydrarouter.com)
...
**hydrarouter menyelesaikan itu semua:**
...
Paket repo ini bersifat privat (`hydrarouter-app`), jadi menjalankan dari source/Docker adalah jalur yang diharapkan untuk pengembangan lokal.
...
### 📺 Panduan Setup Lengkap - hydrarouter + Claude Code Gratis
...
hydrarouter bekerja mulus dengan semua tool AI coding utama:
...
- Tool CLI mengirim dalam format OpenAI → hydrarouter mengonversi → provider menerima dalam format nativenya
...
> hydrarouter sendiri **tidak menagih apa pun**. Kamu hanya membayar langsung ke provider jika memakai layanan berbayar.
>
...
>
> Anggap saja ini "pelacak penghematan" yang menunjukkan berapa banyak yang kamu hemat lewat model gratis dan routing hydrarouter!
...
### 📊 Tentang Biaya dan Penagihan hydrarouter

**Fakta soal penagihan hydrarouter:**

✅ **Software hydrarouter = gratis selamanya** (open source, tanpa tagihan)
...
❌ **hydrarouter tidak mengirim invoice** atau menagih kartumu
...
- **Provider murah** (GLM, MiniMax): bayar langsung, hydrarouter hanya melakukan routing
- **Provider gratis** (iFlow, Kiro, Qwen): benar-benar gratis selamanya, tanpa biaya tersembunyi
- **hydrarouter**: tidak menagih apa pun
...
Dashboard melacak pemakaian token dan menampilkan **estimasi biaya** seandainya kamu memakai API berbayar secara langsung. Ini **bukan tagihan nyata**, melainkan acuan untuk melihat berapa banyak yang kamu hemat dengan memakai model gratis atau langganan yang sudah ada lewat hydrarouter.
...
<details>
<summary><b>💳 Apakah hydrarouter menagih saya?</b></summary>

**Tidak.** hydrarouter adalah software open source gratis yang berjalan di komputermu sendiri. Tidak ada penagihan sama sekali.

**Kamu membayar ke:**
- ✅ **Provider langganan** (Claude Code $20/bulan, Codex $20-200/bulan) → bayar langsung di website masing-masing
- ✅ **Provider murah** (GLM, MiniMax) → bayar langsung, hydrarouter hanya me-routing request
- ❌ **hydrarouter sendiri** → **tidak menagih apa pun**

hydrarouter adalah proxy/router lokal. Ia tidak menyimpan informasi kartu kredit, tidak bisa mengirim invoice, dan tidak punya sistem penagihan. Sepenuhnya software gratis.
...
hydrarouter hanya me-routing request — tidak ada "jebakan" atau tagihan di kemudian hari. Layanannya memang gratis, dan hydrarouter membuatnya lebih mudah dipakai dengan dukungan fallback.

**Catatan:** beberapa provider langganan (Antigravity, GitHub Copilot) punya masa preview gratis dan bisa jadi berbayar nanti, tetapi hal itu diumumkan secara jelas oleh provider tersebut, bukan oleh hydrarouter.
...
3. **Gunakan provider langganan paling akhir:**
   ...
   - hydrarouter memaksimalkan nilainya lewat pelacakan kuota
...
Smart fallback hydrarouter mencegah tagihan tak terduga:
...
**Kamu yang pegang kendali:** atur batas pengeluaran per provider di dashboard, dan hydrarouter akan mematuhinya.
...
**Tips pro:** pakai Opus untuk tugas kompleks, Sonnet kalau mengutamakan kecepatan. hydrarouter melacak kuota per model!
...
docker run -d \
  ...
  ghcr.io/decolua/hydrarouter:latest
```
...
```bash
npm install -g hydrarouter
PORT=20128 HOSTNAME=0.0.0.0 BASE_URL=https://your-domain.com hydrarouter
```
...
MIT License — lihat [LICENSE](https://github.com/decolua/hydrarouter/blob/main/LICENSE) untuk detailnya.

---

<div align="center">

**Kalau hydrarouter membantumu, kasih ⭐ di [GitHub](https://github.com/decolua/hydrarouter)!**

[🌐 Website](https://hydrarouter.com) • [📦 npm](https://www.npmjs.com/package/hydrarouter) • [🐛 Laporkan Bug](https://github.com/decolua/hydrarouter/issues)
