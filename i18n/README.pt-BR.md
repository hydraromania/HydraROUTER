<div align="center">
  <img src="../images/hydrarouter.png?1" alt="Painel do hydrarouter" width="800"/>
  
  # hydrarouter — roteador de IA GRATUITO e economizador de tokens
  ...
  **Conecte todas as ferramentas de código de IA (Claude Code, Cursor, Antigravity, Copilot, Codex, Gemini, OpenCode, Cline, OpenClaw...) a mais de 40 provedores de IA e mais de 100 modelos.**
  ...
  [![npm](https://img.shields.io/npm/v/hydrarouter.svg)](https://www.npmjs.com/package/hydrarouter)
  [![Downloads](https://img.shields.io/npm/dm/hydrarouter.svg)](https://www.npmjs.com/package/hydrarouter)
  [![Docker Pulls](https://img.shields.io/docker/pulls/decolua/hydrarouter.svg?logo=docker&label=Docker%20pulls)](https://hub.docker.com/r/decolua/hydrarouter)
  [![GHCR](https://img.shields.io/badge/GHCR-decolua%2Fhydrarouter-blue?logo=github)](https://github.com/decolua/hydrarouter/pkgs/container/hydrarouter)
  [![Licença](https://img.shields.io/npm/l/hydrarouter.svg)](https://github.com/decolua/hydrarouter/blob/main/LICENSE)

<a href="https://trendshift.io/repositories/22628" target="_blank"><img src="https://trendshift.io/api/badge/repositories/22628" alt="decolua%2Fhydrarouter | Trendshift" style="width: 250px; height: 55px;" width="250" height="55"/></a>

[🚀 Início rápido](#-início-rápido) • [💡 Recursos](#-principais-recursos) • [📖 Configuração](#-guia-de-configuração) • [🌐 Site](https://hydrarouter.com)
...
└──────┬──────┘
       ...
       ↓
┌─────────────────────────────────────────────┐
│           hydrarouter (Roteador inteligente)            │
...
Este pacote de repositório é privado (`hydrarouter-app`), portanto, a execução pelo código-fonte/Docker é o caminho de desenvolvimento local esperado.
  ...
  <tr>
    <td align="center" width="320">
      <a href="https://www.youtube.com/watch?v=X69n5Lm06Yw">
        <img src="https://img.youtube.com/vi/X69n5Lm06Yw/maxresdefault.jpg" alt="Tiết kiệm chi phí LLM với hydrarouter" width="300"/>
</a><br/>
      <b>🇻🇳 Tiếng Việt</b><br/>
      <sub>Tiết kiệm chi phí LLM cho OpenClaw no hydrarouter<br/>por <a href="https://www.youtube.com/c/M%C3%ACAIblog">Mì AI</a></sub>
    </td>
    <td align="center" width="320">
      <a href="https://youtu.be/VQAw612S27Y">
        <img src="https://img.youtube.com/vi/VQAw612S27Y/maxresdefault.jpg" alt="hydrarouter + Claude Code FREE Unlimited Setup" width="300"/>
      </a><br/>
      <b>🇵🇰 اردو / हिन्दी</b><br/>
      <sub>hydrarouter + Claude Code Configuração ilimitada GRATUITA<br/>por <a href="https://www.youtube.com/@BuildAIWithHamid">Construir IA com Hamid</a></sub>
    </td>
    <td align="center" width="320">
<a href="https://www.youtube.com/watch?v=raEyZPg5xE0">
        <img src="https://img.youtube.com/vi/raEyZPg5xE0/maxresdefault.jpg" alt="hydrarouter Setup Tutorial" width="300"/>
      </a><br/>
      <b>🇺🇸 Inglês</b><br/>
      <sub>hydrarouter + Claude Code Configuração GRATUITA<br/>por <a href="https://www.youtube.com/@BuildAIWithHamid">Construir IA com Hamid</a></sub>
    </td>
    <td align="center" width="320">
      <a href="https://youtu.be/3dF5GIYMrcQ?si=bAyfyiHbARJQAHj_">
        <img src="https://img.youtube.com/vi/3dF5GIYMrcQ/hqdefault.jpg" alt="hydrarouter Setup Tutorial" width="300"/>
      </a><br/>
      <b>🇺🇸 Inglês</b><br/>
      <sub>hydrarouter + Claude Code Configuração GRATUITA<br/>por <a href="https://www.youtube.com/@BuildAIWithHamid">Construir IA com Hamid</a></sub>
</td>
...
<img src="https://img.youtube.com/vi/Ttpc26m39Dw/maxresdefault.jpg" alt="Claude CLI Free Setup" width="300"/>
      ...
      <b>🇺🇸 Inglês</b><br/>
      Configuração gratuita <sub>Claude CLI com hydrarouter 🚀<br/>por <a href="https://www.youtube.com/@CodeVerseSoban">CodeVerse Soban</a></sub>
    </td>
    <td align="center" width="320">
      ...
      <b>🇻🇳 Tiếng Việt</b><br/>
      <sub>Cài Đặt OpenClaw Free Từ A-Z + hydrarouter<br/>por <a href="https://www.youtube.com/@maigia">Mai Gia</a></sub>
    </td>
<td align="center" width="320">
    ...
    <td align="center" width="320">
      ...
      <b>🇮🇩 Indonésia</b><br/>
<sub>Koding 24 Jam Anti Rate Limit! Hemat Token AI 65% | Tutorial Configuração Rápida hydrarouter 🚀<br/>por <a href="https://www.youtube.com/@krisswuh">Krisswuh</a></sub>
    </td>
    <td align="center" width="320">
      <a href="https://www.youtube.com/watch?v=TXGv4eofe1I">
        <img src="https://img.youtube.com/vi/TXGv4eofe1I/mqdefault.jpg" alt="Cara Deploy hydrarouter di Hugging Face GRATIS Non-Stop! | Alternatif VPS RAM 16GB" width="300"/>
      </a><br/>
      <b>🇮🇩 Indonésia</b><br/>
      <sub>Cara Implante hydrarouter no Hugging Face GRATUITAMENTE sem parar! | Alternativa VPS RAM 16GB<br/>por <a href="https://www.youtube.com/@krisswuh">Krisswuh</a></sub>
    </td>
  </tr>
  <tr>
    <td align="center" width="320">
<a href="https://www.youtube.com/watch?v=GyX-DLvePW8">
    ...
    <td align="center" width="320">
      <a href="https://www.youtube.com/watch?v=hPusYX-5Pmw">
        <img src="https://img.youtube.com/vi/hPusYX-5Pmw/maxresdefault.jpg" alt="Hướng Dẫn Setup OpenClaw + hydrarouter: Tạo Bot Zalo AI Tự Động Từ A-Z" width="300"/>
      </a><br/>
      <b>🇻🇳 Tiếng Việt</b><br/>
      <sub>Hướng Dẫn Setup OpenClaw + hydrarouter: Tạo Bot Zalo AI Tự Động Từ A-Z<br/>por <a href="https://github.com/tuanminhhole">tuanminhhole</a></sub>
</td>
...
> 🎬 **Fez um vídeo sobre o hydrarouter?** Envie um [Pull Request](https://github.com/decolua/hydrarouter/pulls) adicionando seu vídeo a esta seção - nós o mesclaremos!

---

## 🛠️ Ferramentas CLI suportadas

hydrarouter funciona perfeitamente com todas as principais ferramentas de codificação de IA:
...
Configure `X-hydrarouter-Token-Saver: off` para ignorar todos os economizadores de tokens para uma solicitação de chat.
...
O headroom é opcional e funciona separadamente. hydrarouter chama o endpoint `/v1/compress` local do Headroom e, em seguida, mantém roteamento normal, fallback, autenticação e rastreamento de uso:

```
Cliente → hydrarouter → Headroom /v1/compress → hydrarouter → provedor
```
...
Se o Headroom estiver inativo ou retornar um erro, o o hydrarouter seguirá em modo aberto e enviará a solicitação original.
...
- Sua ferramenta CLI envia formato OpenAI → hydrarouter traduz → Provedor recebe formato nativo
...
> O próprio hydrarouter **nunca cobra** nada. Você paga apenas aos provedores diretamente (se usar serviços pagos).
>
...
> roteamento através do hydrarouter!
...
### 📊 Compreendendo os custos e faturamento do hydrarouter

**Como funciona o faturamento do hydrarouter:**

✅ **Software hydrarouter = GRATUITO para sempre** (código aberto, nunca cobra)  
...
❌ **hydrarouter nunca envia faturas** ou cobra seu cartão
...
- **Provedores baratos** (GLM, MiniMax): pague diretamente, hydrarouter apenas roteia
- **Provedores GRATUITOS** (iFlow, Kiro, Qwen): Genuinamente grátis para sempre, sem taxas ocultas
- **hydrarouter**: Nunca cobra nada
...
O painel rastreia o uso do token e exibe **custos estimados** como se você estivesse usando APIs pagas diretamente. Este **não é faturamento real** - é uma referência para mostrar quanto você está economizando usando modelos gratuitos ou assinaturas existentes através do hydrarouter.
...
<details>
<summary><b>💳 Serei cobrado pelo hydrarouter?</b></summary>

**Não.** hydrarouter é um software gratuito e de código aberto que roda em seu próprio computador. Nunca cobra nada.

**Você só paga:**

- ✅ **Provedores de assinatura** (Claude Code $20/mo, Codex $20-200/mo) → Pague-os diretamente em seus sites
- ✅ **Provedores baratos** (GLM, MiniMax) → Pague diretamente, hydrarouter apenas encaminha suas solicitações
- ❌ **hydrarouter em si** → **Nunca carrega nada, nunca**

hydrarouter é um proxy/roteador local. Não possui cartão de crédito, não pode enviar faturas e não possui sistema de cobrança. É um software totalmente gratuito.
...
O hydrarouter apenas encaminha suas solicitações para eles - não há pegadinhas ou cobrança futura do próprio hydrarouter. Eles são serviços verdadeiramente gratuitos e o hydrarouter os torna fáceis de usar com suporte alternativo.
...
- hydrarouter ajuda a maximizar seu valor por meio do rastreamento de cotas
...
O fallback inteligente do hydrarouter evita cobranças surpresa:
...
**Você está no controle:** Defina limites de gastos por provedor no painel e o hydrarouter os respeita.
...
**Dica profissional:** Use o Opus para tarefas complexas e o Sonnet para velocidade. hydrarouter rastreia cota por modelo!
...
Configurações → Modelos → Avançado:
  ...
  OpenAI API Key: [copie do painel do hydrarouter]
...
```json
{
  ...
  "anthropic_api_key": "your-hydrarouter-api-key"
}
```
...
export OPENAI_API_KEY="your-hydrarouter-api-key"
...
```json
{
  "agents": {
    "defaults": {
      "model": {
        "primary": "hydrarouter/kr/claude-sonnet-4.5"
      }
    }
  },
  "models": {
...
> **Nota:** OpenClaw só funciona com hydrarouter local. Use `127.0.0.1` em vez de `localhost` para evitar problemas de resolução IPv6.
...
```bash
# Clonar e instalar
git clone https://github.com/decolua/hydrarouter.git
cd hydrarouter
npm install
npm run build
...
export DATA_DIR="/var/lib/hydrarouter"
export PORT="20128"
export HOSTNAME="0.0.0.0"
export NODE_ENV="production"
export NEXT_PUBLIC_BASE_URL="http://localhost:20128"
export NEXT_PUBLIC_CLOUD_URL="https://hydrarouter.com"
...
# Ou usar PM2
npm install -g pm2
pm2 start npm --name hydrarouter -- start
pm2 save
pm2 startup
```
...
- Hub Docker: [`decolua/hydrarouter`](https://hub.docker.com/r/decolua/hydrarouter)
- GHCR: [`ghcr.io/decolua/hydrarouter`](https://github.com/decolua/hydrarouter/pkgs/container/hydrarouter)
...
docker run -d --name hydrarouter -p 20128:20128 \
  -v "$HOME/.hydrarouter:/app/data" -e DATA_DIR=/app/data hydrarouter
```
...
```bash
docker logs -f hydrarouter
docker restart hydrarouter
docker stop hydrarouter && docker rm hydrarouter
docker pull decolua/hydrarouter:latest   # atualizar para a versão mais recente
```

**Persistência de dados:** `$HOME/.hydrarouter/db/data.sqlite` no host ↔ `/app/data/db/data.sqlite` no contêiner.

### Variáveis de Ambiente

| Variável | Padrão | Descrição |
| ---------------------------------------------------- | ---------------------------------------- | ----------------------------------------------------------------------------------- |
| `JWT_SECRET` | Gerado automaticamente (`~/.hydrarouter/jwt-secret`) | Segredo de assinatura JWT para cookie de autenticação do painel (substituir para compartilhar entre instâncias) |
| `INITIAL_PASSWORD` | `123456` | Primeira senha de login quando não existe hash salvo |
| `DATA_DIR` | `~/.hydrarouter` | Localização principal dos dados do aplicativo (SQLite em `$DATA_DIR/db/data.sqlite`) |
...
| `CLOUD_URL` | `https://hydrarouter.com` | URL base do endpoint de sincronização na nuvem do lado do servidor |
...
| `NEXT_PUBLIC_CLOUD_URL` | `https://hydrarouter.com` | URL de nuvem pública/compatível com versões anteriores (prefira `CLOUD_URL` para tempo de execução do servidor) |
...
- `${DATA_DIR}` e `~/.hydrarouter` resolvem para o mesmo local em um contêiner Docker — o link simbólico `/root/.hydrarouter -> /app/data` é criado no momento da construção.
...
- Atualizado automaticamente pelo hydrarouter
...
- **Site**: [hydrarouter.com](https://hydrarouter.com)
- **GitHub**: [github.com/decolua/hydrarouter](https://github.com/decolua/hydrarouter)
- **Issues**: [github.com/decolua/hydrarouter/issues](https://github.com/decolua/hydrarouter/issues)

---

## 👥 Colaboradores

Obrigado a todos os colaboradores que ajudaram a tornar o hydrarouter melhor!

[![Contribuidores](https://contrib.rocks/image?repo=decolua/hydrarouter&max=150&columns=15&anon=1&v=20260309)](https://github.com/decolua/hydrarouter/graphs/contributors)

---

## 📊 Gráfico de estrelas

[![Gráfico de estrelas](https://starchart.cc/decolua/hydrarouter.svg?variant=adaptive)](https://starchart.cc/decolua/hydrarouter)

## 🔀 Forks

**[OmniRoute](https://github.com/diegosouzapw/OmniRoute)** — Um fork TypeScript completo do hydrarouter. Adiciona mais de 36 provedores, fallback automático de 4 camadas, APIs multimodais (imagens, incorporações, áudio, TTS), disjuntor, cache semântico, avaliações LLM e um painel sofisticado. Mais de 368 testes de unidade. Disponível via npm e Docker.
...
- **[RTK](https://github.com/rtk-ai/rtk)** ![Stars](https://img.shields.io/github/stars/rtk-ai/rtk?style=flat&color=yellow) — Economizador de tokens em Rust. O hydrarouter porta seu pipeline de compactação para JS → **−20-40% de tokens de entrada** em cada solicitação.
- **[Caveman](https://github.com/JuliusBrussee/caveman)** ![Stars](https://img.shields.io/github/stars/JuliusBrussee/caveman?style=flat&color=yellow) por **[@JuliusBrussee](https://github.com/JuliusBrussee)** — viral _"por que usar muitos tokens quando poucos tokens resolvem"_. hydrarouter adapta seu prompt → **−65% tokens de saída**.
- **[Ponytail](https://github.com/DietrichGebert/ponytail)** ![Estrelas](https://img.shields.io/github/stars/DietrichGebert/ponytail?style=flat&color=yellow) por **[@DietrichGebert](https://github.com/DietrichGebert)** — _"desenvolvedor sênior preguiçoso"_ habilidade. hydrarouter injeta sua abordagem YAGNI-first → **menos tokens, menos código, diferenças mais curtas**.

Um grande agradecimento a esses autores – sem o trabalho deles, os recursos de economia de tokens do hydrarouter não existiriam. Dê uma ⭐ a eles no GitHub!
