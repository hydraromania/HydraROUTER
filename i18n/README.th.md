...
<div align="center">
  <img src="../images/hydrarouter.png?1" alt="แดชบอร์ด hydrarouter" width="800"/>
  ...
  **ผู้ให้บริการ AI ฟรีสำหรับ OpenClaw**
  ...
  [🚀 เริ่มต้นใช้งาน](#-quick-start) • [💡 ฟีเจอร์](#-key-features) • [📖 การตั้งค่า](#-setup-guide) • [🌐 เว็บไซต์](https://hydrarouter.com)
</div>

---

## 🤔 ทำไมต้อง hydrarouter?
...
Repo นี้เป็น private package (`hydrarouter-app`) ดังนั้นการรันจากซอร์ส/Docker คือเส้นทางพัฒนาท้องถิ่นที่คาดไว้
...
hydrarouter ทำงานได้อย่างราบรื่นกับเครื่องมือเขียนโค้ด AI ทุกประเภท:
...
Headroom เป็นตัวเลือกและทำงานแยกกัน hydrarouter เรียก endpoint `/v1/compress` ของ Headroom จากนั้นยังคงเลือกเส้นทาง, fallback, auth และติดตามการใช้งานตามปกติ:
...
ถ้า Headroom ดับหรือคืน error, hydrarouter จะ fail open และส่งคำขอต้นฉบับ
...
- เครื่องมือ CLI ของคุณส่งรูปแบบ OpenAI → hydrarouter แปลง → ผู้ให้บริการได้รับรูปแบบต้นฉบับ
...
<details>
<summary><b>💳 hydrarouter เก็บเงินฉันหรือไม่?</b></summary>

**ไม่.** hydrarouter เป็นซอฟต์แวร์ฟรีแบบ open source ที่ทำงานบนเครื่องของคุณเอง มันไม่มีวันเรียกเก็บเงินจากคุณ

**คุณจ่ายเงินเฉพาะ:**
- ✅ **ผู้ให้บริการสมาชิก** (Claude Code $20/เดือน, Codex $20-200/เดือน) → จ่ายตรงให้พวกเขาบนเว็บไซต์ของพวกเขา
- ✅ **ผู้ให้บริการราคาถูก** (GLM, MiniMax) → จ่ายตรงให้พวกเขา, hydrarouter แค่เลือกเส้นทางคำขอของคุณ
- ❌ **ตัว hydrarouter เอง** → **ไม่มีวันเรียกเก็บเงินใดๆ ทั้งสิ้น**

hydrarouter เป็น proxy/router ท้องถิ่น มันไม่มีบัตรเครดิตของคุณ, ไม่สามารถส่งใบแจ้งหนี้ได้ และไม่มีระบบชำระเงิน เป็นซอฟต์แวร์ฟรีทั้งหมด
...
hydrarouter แค่เลือกเส้นทางคำขอของคุณไปหาพวกเขา — ไม่มี "กับดัก" หรือการเรียกเก็บเงินในอนาคต เป็นบริการที่ฟรีจริงๆ และ hydrarouter ทำให้ใช้งานง่ายด้วยการรองรับ fallback
...
3. **ใช้ผู้ให้บริการสมาชิก** ก็ต่อเมื่อมีอยู่แล้ว:
   - hydrarouter ช่วยเพิ่มประสิทธิภาพมูลค่าของพวกเขาผ่านการติดตามโควตา
...
**OAuth Token หมดอายุ**
- รีเฟรชอัตโนมัติโดย hydrarouter
...
- **เว็บไซต์**: [hydrarouter.com](https://hydrarouter.com)
...
ขอขอบคุณผู้มีส่วนร่วมทุกคนที่ช่วยทำให้ hydrarouter ดียิ่งขึ้น!

[![Contributors](https://contrib.rocks/image?repo=decolua/hydrarouter&max=150&columns=15&anon=1)](https://github.com/decolua/hydrarouter/graphs/contributors)
