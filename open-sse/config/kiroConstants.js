 ...
 * CLIProxyAPIPlus reference implementation, scoped down to what HydraROUTER needs:
 *
 ...
 *
 * Kiro upstream does not advertise `-agentic` model IDs; they are a HydraROUTER
 ...
 * The suffix is a HydraROUTER request override, not part of Kiro's upstream model id.
 */
...
/**
 * Detect whether a model id refers to a HydraROUTER synthetic agentic variant.
...
/**
 * Detect whether a model id is a HydraROUTER synthetic thinking variant
...
/**
 * Resolve a HydraROUTER model id to the real upstream Kiro model id, plus flags
