 ...
 * @param {string[]} [params.fallbackModels]
 * @returns {Promise<FetchResult>}
 */
export async function handleFetchCore({ url, format, maxCharacters, provider, providerConfig, credentials, log, model, fallbackModels }) {
