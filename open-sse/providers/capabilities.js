...
export const PROVIDER_CAPABILITIES = {
  ...
  "nvidia": {
    "deepseek-ai/deepseek-v4-flash-0731": { tools: true, reasoning: true, thinkingFormat: "openai", thinkingCanDisable: true, contextWindow: 1048576, maxOutput: 16384 },
    "deepseek-v4-flash-0731":             { tools: true, reasoning: true, thinkingFormat: "openai", thinkingCanDisable: true, contextWindow: 1048576, maxOutput: 16384 },
    "nvidia/nemotron-3-super-120b-a12b":  { tools: true, reasoning: true, thinkingFormat: "openai", thinkingCanDisable: true, contextWindow: 1048576, maxOutput: 16384 },
    "nemotron-3-super-120b-a12b":         { tools: true, reasoning: true, thinkingFormat: "openai", thinkingCanDisable: true, contextWindow: 1048576, maxOutput: 16384 },
    "nvidia/nemotron-3-ultra-550b-a55b":  { tools: true, reasoning: true, thinkingFormat: "openai", thinkingCanDisable: true, contextWindow: 1048576, maxOutput: 16384 },
    "nemotron-3-ultra-550b-a55b":         { tools: true, reasoning: true, thinkingFormat: "openai", thinkingCanDisable: true, contextWindow: 1048576, maxOutput: 16384 },
    "nvidia/nemotron-3.5-lightning-30b-a3b": { tools: true, reasoning: true, thinkingFormat: "openai", thinkingCanDisable: true, contextWindow: 1048576, maxOutput: 16384 },
    "nemotron-3.5-lightning-30b-a3b":    { tools: true, reasoning: true, thinkingFormat: "openai", thinkingCanDisable: true, contextWindow: 1048576, maxOutput: 16384 },
    "google/gemma-4-31b-it":              { vision: true, tools: true, reasoning: true, thinkingFormat: "openai", thinkingCanDisable: true, contextWindow: 262144, maxOutput: 16384 },
    "gemma-4-31b-it":                     { vision: true, tools: true, reasoning: true, thinkingFormat: "openai", thinkingCanDisable: true, contextWindow: 262144, maxOutput: 16384 },
    "poolside/laguna-xs-2.1":             { tools: true, reasoning: true, thinkingFormat: "openai", thinkingCanDisable: true, contextWindow: 262144, maxOutput: 32000 },
    "laguna-xs-2.1":                      { tools: true, reasoning: true, thinkingFormat: "openai", thinkingCanDisable: true, contextWindow: 262144, maxOutput: 32000 },
    "moonshotai/kimi-k3":                 { vision: true, tools: true, reasoning: true, thinkingFormat: "openai", thinkingCanDisable: false, contextWindow: 1048576, maxOutput: 16384 },
    "kimi-k3":                            { vision: true, tools: true, reasoning: true, thinkingFormat: "openai", thinkingCanDisable: false, contextWindow: 1048576, maxOutput: 16384 },
    ...
    "minimax-m2.7":                       { reasoning: true, thinkingFormat: "openai", thinkingCanDisable: false, contextWindow: 200000, maxOutput: 131072 },
    ...
    "deepseek-ai/deepseek-v4-pro":        { tools: true, reasoning: true, thinkingFormat: "openai", thinkingCanDisable: true, contextWindow: 1000000, maxOutput: 65536 },
    "deepseek-v4-pro":                    { tools: true, reasoning: true, thinkingFormat: "openai", thinkingCanDisable: true, contextWindow: 1000000, maxOutput: 65536 },
    "deepseek-ai/deepseek-v4-flash":      { tools: true, reasoning: true, thinkingFormat: "openai", thinkingCanDisable: true, contextWindow: 1000000, maxOutput: 65536 },
    "deepseek-v4-flash":                  { tools: true, reasoning: true, thinkingFormat: "openai", thinkingCanDisable: true, contextWindow: 1000000, maxOutput: 65536 },
  },
  "codex": {
...
export const PATTERN_CAPABILITIES = [
  ...
  { pattern: "*gemini-3.8*",    caps: { vision: true, audioInput: true, videoInput: true, reasoning: true, search: true, thinkingFormat: "gemini-level", thinkingCanDisable: false, contextWindow: 250000, maxOutput: 65536 } },
  { pattern: "*gemini-3.7*",    caps: { vision: true, audioInput: true, videoInput: true, reasoning: true, search: true, thinkingFormat: "gemini-level", thinkingCanDisable: false, contextWindow: 250000, maxOutput: 65536 } },
  { pattern: "*gemini-3.6*",    caps: { vision: true, audioInput: true, videoInput: true, reasoning: true, search: true, thinkingFormat: "gemini-level", thinkingCanDisable: false, contextWindow: 250000, maxOutput: 65536 } },
  { pattern: "*gemini-3.5*",    caps: { vision: true, audioInput: true, videoInput: true, reasoning: true, search: true, thinkingFormat: "gemini-level", thinkingCanDisable: false, contextWindow: 250000, maxOutput: 65536 } },
  ...
  { pattern: "*gemini-3*",      caps: { vision: true, audioInput: true, videoInput: true, reasoning: true, search: true, thinkingFormat: "gemini-level", thinkingCanDisable: false, contextWindow: 250000, maxOutput: 65536 } },
  { pattern: "*gemini-2.5*",    caps: { vision: true, audioInput: true, videoInput: true, reasoning: true, search: true, thinkingFormat: "gemini-budget", thinkingRange: { min: 0, max: 24576 }, contextWindow: 250000, maxOutput: 65536 } },
