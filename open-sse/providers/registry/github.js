export default {
  ...
  models: [
    ...
    { id: "text-embedding-3-small", name: "Text Embedding 3 Small (GitHub)", dimensions: 1536, kind: "embedding" },
    { id: "text-embedding-3-large", name: "Text Embedding 3 Large (GitHub)", dimensions: 3072, kind: "embedding" },
  ],
