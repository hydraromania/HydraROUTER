export default {
  ...
  models: [
    ...
    { id: "text-embedding-bge-m3", name: "BGE-M3 Embedding", dimensions: 1024, kind: "embedding" },
    { id: "text-embedding-qwen3-8b", name: "Qwen3 8B Embedding", dimensions: 4096, kind: "embedding" },
