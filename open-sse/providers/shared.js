...
// Keep this static even when HydraROUTER runs on Linux: the provider profile is
...
// Antigravity OAuth client credentials — resolved ONLY from env so no secret
// is ever committed (GitHub push protection). Set HYDRAROUTER_ANTIGRAVITY_*
// in .env; see .env.example. Empty string = OAuth disabled for this provider.
...
// Gemini (Google) OAuth client credentials — env-only, same reason as above.
