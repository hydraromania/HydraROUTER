 ...
 * into HydraROUTER-shaped variants:
 *
 *   {upstream}                          - base model
 ...
 * API. They are HydraROUTER fictions and the `openai-to-kiro` translator strips
...
/**
 * Build the synthetic HydraROUTER variant set for a single upstream Kiro model.
 *
 ...
 * into HydraROUTER variants (`-thinking`, `-agentic`, `-thinking-agentic`).
 *
