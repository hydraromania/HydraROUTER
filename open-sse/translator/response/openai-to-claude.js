...
// Convert a non-streaming OpenAI Chat Completions body into a Claude Message.
// Shared by the non-streaming + forced-SSE→JSON handlers so both return a
// real `type: "message"` body when the client speaks Claude.
