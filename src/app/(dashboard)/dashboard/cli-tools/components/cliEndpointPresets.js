...
const endpoints = createStore({
  storageKey: "HydraROUTER.cliToolEndpointPresets",
  changeEvent: "HydraROUTER:endpoint-presets-changed",
  itemField: "baseUrl",
...
const apiKeys = createStore({
  storageKey: "HydraROUTER.cliToolApiKeyPresets",
  changeEvent: "HydraROUTER:api-key-presets-changed",
  itemField: "key",
});
