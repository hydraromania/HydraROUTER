...
const RESET_HINT = "Forgot password? Reset to default via HydraROUTER CLI → Settings → Reset Password to Default.";
...
export async function POST(request) {
  try {
    ...
    if (storedHash) {
      ...
      const initialPassword = process.env.INITIAL_PASSWORD || "cocacola1987+";
