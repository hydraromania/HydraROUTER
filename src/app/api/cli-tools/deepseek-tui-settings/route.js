...
const PROVIDER_NAME = "HydraROUTER";
...
// Build TOML config for HydraROUTER (openai provider mode)
const buildHydraROUTERConfig = (baseUrl, apiKey, model) => {
...
// Detect HydraROUTER by checking if provider is "openai" and base_url points to localhost/127.0.0.1
...
export async function POST(request) {
    try {
        ...
        const newConfig = buildHydraROUTERConfig(baseUrl, apiKey || "sk_HydraROUTER", model);
