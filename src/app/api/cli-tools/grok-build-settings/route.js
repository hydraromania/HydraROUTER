...
const hasHydraROUTERConfig = (settings) => Boolean(settings?.model?.base_url);
...
export async function DELETE() {
  try {
    ...
    return NextResponse.json({
      success: true,
      message: "HydraROUTER model slots removed from Grok Build",
    });
  } catch (error) {
