...
import { filterModelsListForApiKey } from "@/lib/apiKeyModelFilter.js";
import { getApiKeyByKey } from "@/lib/localDb.js";
...
export async function GET(request, { params }) {
  try {
    ...
    if (!matchedModel || (allowedSet && !allowedSet.has(identifier))) {
      return json(
        {
          error: {
