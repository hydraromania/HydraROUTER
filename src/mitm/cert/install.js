...
const ROOT_CA_CN = "HydraROUTER MITM Root CA";
...
async function installCertMac(sudoPassword, certPath) {
  ...
  const deleteOld = `security delete-certificate -c "HydraROUTER MITM Root CA" /Library/Keychains/System.keychain 2>/dev/null || true`;
