...
export const GITHUB_CONFIG = {
  changelogUrl: "https://raw.githubusercontent.com/hydraromania/HydraROUTER/refs/heads/master/CHANGELOG.md",
  donateUrl: "https://hydrarouter.com/api/donate",
};

// Updater configuration
export const UPDATER_CONFIG = {
  npmPackageName: "hydrarouter",
  installCmd: "npm i -g hydrarouter",
  installCmdLatest: "npm i -g hydrarouter@latest --prefer-online",
