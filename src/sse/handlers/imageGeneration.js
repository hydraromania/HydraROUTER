...
export async function handleImageGeneration(request) {
  ...
  if (comboModels) {
    ...
    return handleComboChat({
      body,
      models: comboModels,
      handleSingleModel: (b, m) => handleSingleModelImage(b, m, { wantsStream, binaryOutput, preferredConnectionId, apiKey, pathname: url.pathname }),
      log,
      comboName: modelStr,
      comboStrategy,
      comboStickyLimit,
  ...
  return handleSingleModelImage(body, modelStr, { wantsStream, binaryOutput, preferredConnectionId, apiKey, pathname: url.pathname });
}

async function handleSingleModelImage(body, modelStr, { wantsStream, binaryOutput, preferredConnectionId, apiKey = null, pathname = "/v1/images/generations" } = {}) {
