...
function localRequest(pathname, headers = {}) {
  return request(pathname, { "x-hr-peer-token": PEER_TOKEN, "x-hr-real-ip": "127.0.0.1", ...headers });
}
